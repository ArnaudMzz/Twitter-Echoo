...
$conversations = User::getConversations($_SESSION['user']['id_user']);
$default_avatar = '../uploads/avatars/DefaultAvatar.png';
$avatar_url = !empty($_SESSION['user']['avatar_url']) ? $_SESSION['user']['avatar_url'] : $default_avatar;
$bio = !empty($_SESSION['user']['bio']) ? $_SESSION['user']['bio'] : 'Aucune bio disponible.';
?>
<!DOCTYPE html>
<html lang="fr">
                ...
                <div class="conversation-list">
                    <?php foreach ($conversations as $conversation) : ?>
                        <div class="conversation-item">
                            <a class="box-account" href="Messages.php?id_receiver=<?= $conversation['id_user'] ?>">
                                <div class="user-avatar">
                                    <img src="<?= !empty($conversation['avatar_url']) ? $conversation['avatar_url'] : $default_avatar; ?>" alt="Photo de profil">
                                </div>
                                <div class="user-info">
                                    <h2><?= htmlspecialchars($conversation['username']) ?></h2>
                                    <p class="user-bio"><?= !empty($conversation['bio']) ? htmlspecialchars($conversation['bio']) : 'Aucune bio disponible.'; ?></p>
                                </div>
                            </a>
                        </div>
                    <?php endforeach; ?>
